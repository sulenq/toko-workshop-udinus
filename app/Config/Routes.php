...
$routes->get('shop/getvouchersdata', 'Shop::getVouchersData');
$routes->post('shop/getvouchersdata', 'Shop::getVouchersData');
$routes->add('shop/getvouchersdata', 'Shop::getVouchersData');
